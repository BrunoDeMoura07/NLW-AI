...
export class AutoModel extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: (Map<string, (string | typeof BertModel)[]> | Map<string, (string | typeof BloomModel)[]>)[];
}
/**
...
export class AutoModelForImageClassification extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: Map<string, (string | typeof ViTForImageClassification)[]>[];
}
/**
...
export class AutoModelForImageSegmentation extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: Map<string, (string | typeof DetrForSegmentation)[]>[];
}
/**
...
export class AutoModelForCTC extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: Map<string, (string | typeof Wav2Vec2ForCTC)[]>[];
}
export class AutoModelForAudioClassification extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: Map<string, (string | typeof Wav2Vec2ForSequenceClassification)[]>[];
}
